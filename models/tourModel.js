...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minLength: [10, 'A tour can not have less than 10 characters'],
    },
    slug: String,
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficulty can only be either: easy, medium or difficulty',
      },
    },
    ratingsAverage: {
      type: Number,
      ...
      max: [5, 'Rating can not be over 5.0 '],
    },
    ratingsQuantity: {
      type: Number,
      default: 0,
